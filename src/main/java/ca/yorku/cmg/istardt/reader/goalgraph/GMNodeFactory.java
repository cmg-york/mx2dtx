...
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.CrossRunSet;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Effect;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.EffectGroup;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.ElementWithFormula;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.ExportedSet;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Goal;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.GraphElement;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.InitializationSet;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Link;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Precondition;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Quality;
import ca.yorku.cmg.istardt.reader.inputs.drawio.graphelementstructure.Task;
